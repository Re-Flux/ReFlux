...
/**
 * Copyright (C) 2017 ReFlux
 * Based on FluxBB v1.5.10 original code by Rickard Andersson copyright (C) 2002-2008 PunBB
...
if ($action == 'check_upgrade')
{
	...
	$latest_version = trim(@file_get_contents('http://re-flux.com/version/latest_version'));
	...
	if (version_compare($pun_config['o_cur_version'], $latest_version, '>='))
		...
		message(sprintf($lang_admin_index['New version available message'], '<a href="http://re-flux.com/">Re-Flux.com</a>'));
}
// Remove install.php
		...
		<div id="adstats" class="box">
			<div class="inbox">
				<dl>
					...
					<dd>
						<a href="http://re-flux.com/forums/"><?php echo $lang_admin_index['Forum label'] ?></a>
					</dd>
				</dl>
			</div>
		</div>
